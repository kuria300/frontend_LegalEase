        ...
        <div className="cl-table-wrap">
          <table className="cl-table">
            ...
            <tbody>
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={7} className="cl-empty">No consultations found.</td>
                </tr>
              ) : (
                filtered.map((c) => (
                  <tr key={c.id} className="cl-row">
                    ...
                    {/* Status */}
                    <td>
                      <span className={`cl-status ${STATUS_CONFIG[c.status].className}`}>
        ...
        <div className="cl-modal-overlay" onClick={() => setSelected(null)}>
          <div className="cl-modal" onClick={(e) => e.stopPropagation()}>
            <div className="cl-modal-header">
              ...
              <button className="cl-modal-close" onClick={() => setSelected(null)}>
                <X size={18} />
              </button>
            </div>
            <div className="cl-modal-body">
              ...
              <span className={`cl-status ${STATUS_CONFIG[selected.status].className}`}>
              ...
              <div className="cl-modal-grid">
                ...
                <div className="cl-modal-item">
                  ...
                  <p className="cl-modal-item-value">{selected.duration} minutes</p>
                </div>
              </div>
            </div>
          </div>
