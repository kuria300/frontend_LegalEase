...
export default function LawyerHomepage() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#f0f2f5] text-[#101828] antialiased p-6 md:p-8 flex flex-col justify-start">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {bookings.map((b) => (
              <div key={b.id} className="flex items-start gap-4 p-3 rounded-[10px] border border-[#e4e7ec] bg-white hover:bg-slate-50/50 transition-colors">
                ...
                <div className="flex flex-col items-end justify-between h-full gap-2 shrink-0">
                  ...
                  <button className="text-slate-400 hover:text-slate-600 font-bold px-1 text-xs tracking-widest">•••</button>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white border border-[#e4e7ec] rounded-[14px] p-5 shadow-sm flex flex-col">
          ...
          <div className="flex flex-col gap-4 flex-1 justify-between">
            ...
            <button className="w-full mt-2 py-2.5 px-4 bg-white border border-[#e4e7ec] text-[#3b5bdb] hover:bg-[#f0f4ff] rounded-md text-xs font-semibold tracking-wide transition-colors text-center shadow-sm">
              View All Requests
            </button>
          </div>
        </div>
