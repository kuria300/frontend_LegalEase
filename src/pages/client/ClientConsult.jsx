      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4 p-6 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-3 text-sm text-gray-700">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium">{formatTime(appt.booking_time)}</span>
          </div>
          <div className="flex justify-between">
...
function AppointmentCard({ appt, tab, onReschedule, onViewDetails }) {
  const client = appt.users_bookings_lawyer_idTousers;
...
const ClientConsult = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-3 items-center justify-center py-20 w-full min-h-screen">
        <div className="w-8 h-8 border-4 border-[#3b5bdb] border-t-transparent rounded-full animate-spin" />
        <span className="ml-3 text-gray-500">Loading consultations...</span>
      </div>
    );
  }
